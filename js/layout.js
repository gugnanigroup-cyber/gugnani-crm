  ...
  render: function(title = "Dashboard") {
    ...
    const sidebar = `
      <div class="sidebar bg-secondary text-white d-flex flex-column h-100" id="sidebar">
          <div class="sidebar-header p-4 text-center brand-logo">
              <i class="fa-solid fa-car-side text-primary fs-3"></i> 
              <div class="fw-bold mt-2" style="letter-spacing: 1px;">GUGNANI TYRES</div>
          </div>
